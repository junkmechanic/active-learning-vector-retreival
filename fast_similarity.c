...
static PyObject *__pyx_f_15fast_similarity_printSimilarityMatrix(struct __pyx_t_15fast_similarity_Similarity *, __pyx_t_15fast_similarity_ULong, PyObject *); /*proto*/
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("fast_similarity.getSimilarity", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}
      ...
      /*try:*/ {
        {
            ...
            #endif
            #ifdef _OPENMP
            #pragma omp parallel  private(__pyx_t_2, __pyx_t_3, __pyx_t_4, __pyx_t_5, __pyx_t_6)
            #endif /* _OPENMP */
            {
 ...
 */
                ...
                if (1 == 0) abort();
                {
                    ...
                    {
                        #ifdef _OPENMP
                        #pragma omp for lastprivate(__pyx_v_counter) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_j) schedule(guided)
                        #endif /* _OPENMP */
...
static char __pyx_doc_15fast_similarity_3main[] = "\n    Before running, change the value of batch_size to speed up reading the\n    input file\n    ";
static PyMethodDef __pyx_mdef_15fast_similarity_4main = {"main", (PyCFunction)__pyx_pw_15fast_similarity_4main, METH_NOARGS, __pyx_doc_15fast_similarity_3main};
